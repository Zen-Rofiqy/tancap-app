...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final CameraVersionAccessors vaccForCameraVersionAccessors = new CameraVersionAccessors(providers, config);
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: coroutinesTest (1.6.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: exifinterface (1.3.6)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: navigation (2.4.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
        ...
        /**
         * Returns the group of versions at versions.camera
         */
        public CameraVersionAccessors getCamera() {
            return vaccForCameraVersionAccessors;
        }
        ...
        /**
         * Returns the group of versions at versions.tensorflow
         */
    ...
    public static class CameraVersionAccessors extends VersionFactory  {

        public CameraVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Returns the version associated to this alias: camera.camera2 (1.1.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getCamera2() { return getVersion("camera.camera2"); }

            /**
             * Returns the version associated to this alias: camera.core (1.1.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getCore() { return getVersion("camera.core"); }

            /**
             * Returns the version associated to this alias: camera.lifecycle (1.1.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getLifecycle() { return getVersion("camera.lifecycle"); }

            /**
             * Returns the version associated to this alias: camera.view (1.3.3)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getView() { return getVersion("camera.view"); }
    ...
    public static class CameraxVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        public Provider<String> asProvider() { return getVersion("camerax"); }
            ...
            /**
             * Returns the version associated to this alias: camerax.extensions (1.0.0-alpha29)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getExtensions() { return getVersion("camerax.extensions"); }

    }

    public static class TensorflowVersionAccessors extends VersionFactory  {

        private final TensorflowLiteVersionAccessors vaccForTensorflowLiteVersionAccessors = new TensorflowLiteVersionAccessors(providers, config);
        public TensorflowVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Returns the group of versions at versions.tensorflow.lite
         */
        public TensorflowLiteVersionAccessors getLite() {
            return vaccForTensorflowLiteVersionAccessors;
        }

    }

    public static class TensorflowLiteVersionAccessors extends VersionFactory  implements VersionNotationSupplier {

        public TensorflowLiteVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Returns the version associated to this alias: tensorflow.lite (2.7.0)
         * If the version is a rich version and that its not expressible as a
         * single version string, then an empty string is returned.
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> asProvider() { return getVersion("tensorflow.lite"); }

            /**
             * Returns the version associated to this alias: tensorflow.lite.support (0.2.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getSupport() { return getVersion("tensorflow.lite.support"); }
